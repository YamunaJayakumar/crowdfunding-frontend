...
function Register() {
  ...
  const handleRegister=()=>{
    const {username,email,password}=userDeatails
    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-cover bg-center "
      ...
      <div className="w-full max-w-md bg-white rounded-3xl shadow-xl overflow-hidden">
        ...
        <div className="p-10 flex flex-col justify-center">
          ...
          {/* Username */}
          <input
          onChange={e=>setUserDetails({...userDeatails,username:e.target.value})}
            type="text"
          ...
          {/* Email */}
          <input
          onChange={e=>setUserDetails({...userDeatails,email:e.target.value})}
            type="email"
          ...
          {/* Password */}
          <input
          onChange={e=>setUserDetails({...userDeatails,password:e.target.value})}
            type="password"
